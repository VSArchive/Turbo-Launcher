...
import amirz.turbo.customization.IconDatabase;
import amirz.turbo.customization.ShadeStyle;
import amirz.turbo.customization.IconShapeOverride;
import amirz.turbo.icons.pack.IconPackManager;
import amirz.turbo.settings.DockSearchPrefSetter;
import amirz.turbo.settings.FeedProviderPrefSetter;
import amirz.turbo.settings.IconPackPrefSetter;
import amirz.turbo.settings.ReloadingListPreference;
import amirz.turbo.util.AppReloader;

import static amirz.turbo.TurboFont.KEY_FONT;
import static amirz.turbo.TurboLauncherCallbacks.KEY_ENABLE_MINUS_ONE;
import static amirz.turbo.TurboLauncherCallbacks.KEY_FEED_PROVIDER;
import static amirz.turbo.customization.ShadeStyle.KEY_THEME;
import static amirz.turbo.customization.DockSearch.KEY_DOCK_SEARCH;
import static amirz.turbo.customization.IconShapeOverride.KEY_ICON_SHAPE;
