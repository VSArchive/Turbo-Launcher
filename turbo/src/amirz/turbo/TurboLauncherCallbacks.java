...
import amirz.turbo.animations.TransitionManager;
import amirz.turbo.hidden.HiddenAppsDrawerState;
import amirz.turbo.search.AllAppsQsb;
import amirz.turbo.sleep.WorkspaceSleepListener;
import amirz.unread.UnreadSession;

import static amirz.turbo.TurboFont.DEFAULT_FONT;
...
import static amirz.turbo.animations.TransitionManager.KEY_FADING_TRANSITION;
...
public class TurboLauncherCallbacks implements LauncherCallbacks,
    ...
    private final TurboLauncher mLauncher;
    private final Handler mHandler = new Handler();
    private final Bundle mPrivateOptions = new Bundle();

    private LauncherClient mLauncherClient;
    private TurboLauncherOverlay mOverlayCallbacks;
    private boolean mDeferCallbacks;

    private boolean mNoFloatingView;

    TurboLauncherCallbacks(TurboLauncher launcher) {
        mLauncher = launcher;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mOverlayCallbacks = new TurboLauncherOverlay(mLauncher);
